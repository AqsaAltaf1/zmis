<?php
class Dist_head_wise_report_model extends CI_model{
	...
	function gaTotalList($getfinancial_year,$getInstallment,$userid)
	{
	...
	function maTotalList($getfinancial_year,$getInstallment,$userid)
	{
		$this->db->select("*");
		$this->db->from("mustahiqeen");
	...
	function dmTotalList($getfinancial_year,$getInstallment,$userid)
	{
		$this->db->select("*");
		$this->db->from("mustahiqeen");
	...
	function esTotalList($getfinancial_year,$getInstallment,$userid)
	{
		$this->db->select("*");
		$this->db->from("mustahiqeen");
	...
	function gaPaidList($getfinancial_year,$getInstallment,$userid)
	{
		$this->db->select("District_Name, mustahiq_name, father_name, mustahiq_cnic, gender, contact_number, LZCActualName, category");
		$this->db->from("mustahiqeen");
		$this->db->where('MustahiqType',"Guzara Allowance");
	...
	function maPaidList($getfinancial_year,$getInstallment,$userid)
	{
		$this->db->select("*");
		$this->db->from("mustahiqeen");
		$this->db->where('MustahiqType',"Marriage Assistance");
