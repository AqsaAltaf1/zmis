<?php
class Dist_ESA_mustahiq_reg_model extends CI_model{

	
	function manage_esa_mustahiq_reg($formArray)
	{
	...
	function dist_esa_mustahiq_list($userid,$getfinancial_year,$getfinancial_installment)
	{
		$this->db->select("*");
	...
	function deleteESArecord($studentID)
  {
