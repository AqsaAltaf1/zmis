<?php
class Dist_DM_mustahiq_reg_model extends CI_model{

	
	function dist_dm_mustahiq_register($formArray)
	{
		$this->db->insert("mustahiqeen",$formArray);
	}
	
	function get_all_madrassa_list($userid)
	{
		$this->db->select("*");
	...
	function get_all_madrassa_tablevalues($userid,$getfinancial_year,$getfinancial_installment)
	{
		$this->db->select("*");
	...
	function getDeeniMadarisPrint($userid,$getfinancial_year,$getfinancial_installment)
	{
		$this->db->select("*");
		$this->db->from("mustahiqeen");
		$this->db->where("district_id",$userid);
	...
	function deleteMadarisRecord($studentID){
