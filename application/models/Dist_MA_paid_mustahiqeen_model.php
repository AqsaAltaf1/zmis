<?php
class Dist_MA_paid_mustahiqeen_model extends CI_model{
	...
	function dist_ma_paid_mustahiqeen()
	{
	...
	function getMarriageMustahiqeenPrint($userid,$getfinancial_year,$getfinancial_installment)
	{
		$userid = $this->session->userdata('id');
			$this->db->select("*");
		$this->db->from("mustahiqeen_payments");
