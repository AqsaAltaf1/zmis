<?php
class Posts_list_model extends CI_model{
	...
	function hq_posts_list()
	{
		$this->db->select("*");
		$this->db->from("add_post");
		$this->db->where('post_location','Head Quarter Level');
		$this->db->order_by('id',"DESC");
		return $postHq_list = $this->db->get()->result_array();
	}
		...
		->from('add_post')
		->join('district_users', 'district_users.id = add_post.district_id')
		->order_by('add_post.id',"DESC")->get()->result_array();
		}
