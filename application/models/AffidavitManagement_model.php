<?php
class AffidavitManagement_model extends CI_model
{



	function getFormReceivedLZC()
	{
		$this->db->select("*");
	...
	function editAffidavitForm($formArray,$affidavitID)
	{
	
	$this->db->where('id',$affidavitID);
	$this->db->update('zakatentryforms',$formArray);		
	}
