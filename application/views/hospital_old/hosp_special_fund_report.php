...
<h3 class="m-0 text-dark"><strong><?php echo $hospital_name;?></strong> Hospital Special Health Fund Reporting</h3>
...
<span class="info-box-number">Opening Balance</span>
...
<div class="info-box-content text_align">
<span class="info-box-number">Expenditure During the Month</span>
...
<div class="info-box-content text_align">
<span class="info-box-number">Closing Balance</span>
...
<div class="card-header">
<h3 class="card-title">Expenditure of Special Health Fund by  <strong><?php echo $hospital_name ?></strong>  During  Start Date:<strong>_____</strong> End Date: <strong>_____</strong> </h3>
