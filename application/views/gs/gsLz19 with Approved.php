...
$CategoryQuery = $this->db->query("SELECT category, COUNT(*)as mustaghiqCategory FROM `mustahiqeen` WHERE `year` = '".$getfinancial_year."' AND `district_id` = '".$userid."' AND `addedby` = '".$username."'  GROUP BY category order BY category ");
