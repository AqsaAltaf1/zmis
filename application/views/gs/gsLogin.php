...
<title>Group Secretary | Log in</title>
...
<a href="#"><b>Group Secretary </b>Dashboard</a>
...
<form action="<?php echo base_url('GsLogin/formData');?>" method="post" enctype="multipart/form-data">
