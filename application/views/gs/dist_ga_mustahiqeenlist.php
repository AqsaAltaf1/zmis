...
<head>
  ...
  <title> <?php $this->load->view('gs/include/title');?></title>
...
<a target="_blank" href="<?php echo base_url(); ?>Dist_GA_Mustahiqeenlist/dist_selected_mustahiqeen_print/<?php echo $getlzc_id;?>" class="btn btn-primary btn-sm float-right" id="printMustahiq" style="display:none;">Print Mustahiqeen List</a>
...
$this->db->where('lzc_id',$getmustahiqinfo['LZC_id']);
$result = $this->db->get('mustahiqeen_payments')->num_rows();
if($result == 1)
{
?>
...
else if ($getmustahiqinfo['Remarks'] == "")
{
?>


<a href="#" class="btn btn-danger btn-sm">Not Audited</a>
<?php 
}
else
{
...
<input type="text" name="name" id="name" value="<?php echo $getmustahiqinfo['mustahiq_name']?>" readonly class="form-control col-md-4 col-xs-12">

<label class="col-md-2" for="f_name">Father Name <span class="required">*</span>
</label>
<input type="text" name="f_name" id="f_name" value="<?php echo $getmustahiqinfo['father_name']?>" readonly class="form-control col-md-4 col-xs-12">
</div>

<div class="row form-group">
<label class="col-md-2" for="cnic">CNIC/Form-B <span class="required">*</span>
</label>
<input type="text" name="cnic" id="cnic" value="<?php echo $getmustahiqinfo['mustahiq_cnic']?>" readonly class="form-control col-md-4 col-xs-12">

<label class="col-md-2" for="mustahiq_category">Category <span class="required">*</span>
</label>
<input type="text" name="mustahiq_category" id="mustahiq_category" value="<?php echo $getmustahiqinfo['category']?>" readonly class="form-control col-md-4 col-xs-12">
</div>
...
<input type="hidden" name="user_id" value="<?php echo $getmustahiqinfo['id']?>">
<input type="hidden" name="lzc_id" value="<?php echo $getmustahiqinfo['LZC_id'];?>">
<input type="hidden" name="lzcName" value="<?php echo $getmustahiqinfo['LZCActualName'];?>">
<input type="hidden" name="districtName" value="<?php echo $getmustahiqinfo['District_Name'];?>">
</form>
</div>
</div>
</div>
