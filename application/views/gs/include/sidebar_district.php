...
<?php 
if(($page == "Dist_dashboard") || ($page == "Dist_institution_reg") || ($page == "DistRejectedMustahiqeen"))
{
?>
...
<?php 
if(($page == "Dist_fund_summary") || ($page == "Dist_fund_summary") || ($page == "Dist_category_wise_report") || ($page == "Dist_head_wise_report") || ($page == "Dist_HR_reports") )
{
?>
<li class="nav-item has-treeview menu-open">
<a href="#" class="nav-link active">
