...
<li class="nav-item">
<a href="<?php echo base_url();?>Dist_GA_lz_19/gsLz19" class="nav-link <?php if($page == "Dist_GA_lz_19") echo "active";?>">
  <i class="far fa-dot-circle nav-icon"></i>
...
<li class="nav-item">
<a href="<?php echo base_url(); ?>Dist_GA_lz_11/gsLz11" class="nav-link <?php if($page == "Dist_GA_lz_11") echo "active";?>">
  <i class="far fa-dot-circle nav-icon"></i>
...
<li class="nav-item">
<a href="<?php echo base_url(); ?>Dist_GA_paid_mustahiqeen/gsPaidList" class="nav-link <?php if($page == "Dist_GA_paid_mustahiqeen") echo "active";?>">
  <i class="far fa-dot-circle nav-icon"></i>
