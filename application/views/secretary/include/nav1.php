...
if(($session_id == "") || ($district_name == "") || ($username == "") || ($user_type == "") || ($entityName== ""))
{
...
if($user_type == "audit")
{
 echo $username."(AO)".$entityName;
} 
else if($user_type == "gs")

{
echo $username."(GS)".$entityName;
}
?>
</strong>
...
<?php 
if ($user_type == "audit" || $user_type == "gs")
{
?>
<a href="#" class="dropdown-item">Profile</a>
<a href="<?php echo base_url(); ?>GsLogin/logout" class="dropdown-item">Log Out</a>
<?php 
} 
else
{
?>
<a href="<?php echo base_url(); ?>Dist_login/user_login_profile" class="dropdown-item">Profile</a>
