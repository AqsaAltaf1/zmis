...
<title>
<?php $this->load->view('secretary/include/title');?>
</title>
...
<h3 align="center"><strong>Guzara Allowance,Marriage Assistance and Health Care Paid Utilization Report of All district for the Financial Year <?php echo $getfinancial_year;?></strong></h3>
...
<?php
$ga_disbursement_query = $this->db->select_sum('payment_amount')->from('mustahiqeen_payments')->where('payment_amount',12000)->where('financial_Year',$getfinancial_year)->where('district_id',$getdistrict['id'])->where('installment',$get_inst)->get();
 $total_ga_disbursement = $ga_disbursement_query->row('payment_amount');
 $total_GA_disbursement1 += $total_ga_disbursement;
echo $total_ga_disbursement_nf = number_format($ga_disbursement_query->row('payment_amount'),0);
...
<td>
<?php 
$ma_disbursement_query = $this->db->select_sum('payment_amount')->from('mustahiqeen_payments')->where('payment_amount',30000)->where('financial_Year',$getfinancial_year)->where('district_id',$getdistrict['id'])->where('installment',$get_inst)->get();
 $total_ma_disbursement = $ma_disbursement_query->row('payment_amount');
 $total_MA_disbursement1 += $total_ma_disbursement;
echo $total_ma_disbursement_nf = number_format($ma_disbursement_query->row('payment_amount'),0);
?>
</td>
<td>
<?php 
...
$hc_disbursement_query = $this->db->select_sum('amount')->from('hc_mustahiqeen')->where('hospital_type !=','provincial_hospital')->where('year',$getfinancial_year)->where('district_id',$getdistrict['id'])->where('installment',$get_inst)->get();
$total_hc_disbursement = $hc_disbursement_query->row('amount');
$total_hc_disbursement1 += $total_hc_disbursement;
echo $total_hc_disbursement_nf = number_format($hc_disbursement_query->row('amount'),0);
...
<?php
$dm_disbursement_query = $this->db->select_sum('amount')->from('mustahiqeen')->where('MustahiqType','Deeni Madaris')->where('year',$getfinancial_year)->where('district_id',$getdistrict1['id'])->where('installment',$get_inst)->get();
 $total_dm_disbursement = $dm_disbursement_query->row('amount');
 $total_DM_disbursement1 += $total_dm_disbursement;
echo $total_dm_disbursement_nf = number_format($dm_disbursement_query->row('amount'),0);
...
<td>
<?php 
$esa_disbursement_query = $this->db->select_sum('amount')->from('mustahiqeen')->where('MustahiqType','Educational Stipend (A)')->where('year',$getfinancial_year)->where('district_id',$getdistrict1['id'])->where('installment',$get_inst)->get();
 $total_esa_disbursement = $esa_disbursement_query->row('amount');
 $total_ESA_disbursement1 += $total_esa_disbursement;
echo $total_esa_disbursement_nf = number_format($esa_disbursement_query->row('amount'),0);
?>
</td>
<td>
<?php 
...
$esp_disbursement_query = $this->db->select_sum('amount')->from('mustahiqeen')->where('MustahiqType','Educational Stipend (P)')->where('year',$getfinancial_year)->where('district_id',$getdistrict1['id'])->where('installment',$get_inst)->get();
$total_esp_disbursement = $esp_disbursement_query->row('amount');
$total_ESP_disbursement1 += $total_esp_disbursement;
echo $total_esp_disbursement_nf = number_format($esp_disbursement_query->row('amount'),0);
