...
<tr>
    ...
    <td rowspan="4">
			...
			<br><br>
			<a style="width:270px; background:#024870;" class="btn btn-success btn-xl js-scroll-trigger" href="<?php echo base_url();?>secLogin/">Secretary Login</a>
			<a style="width:270px; background:#024870;" class="btn btn-success btn-xl js-scroll-trigger" href="<?php echo base_url();?>ZakatMustahiqSearch/">Mustahiq Search</a>
			<br /> <br />
            ...
            <a style="width:270px; background:#007bff;" class="btn btn-success btn-xl js-scroll-trigger" href="<?php echo base_url();?>GsLogin/">Group Secretary Login</a>
