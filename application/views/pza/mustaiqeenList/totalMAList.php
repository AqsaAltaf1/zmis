...
<table width="100%" border="0" style="background:#E1E1E1;">
  <tr align="center">
    ...
    <td width="56%"><h4 class="card-title">Marriage Assistance Mustahiqeen List  <br />
...
<?php
$i=1;
if(!empty($maTotalList))
{
foreach($maTotalList as $maList)
{
?>
<tr>
<td><?php echo $i;?></td>
<td><?php echo $maList['District_Name']; ?></td>
<td><?php echo $maList['mustahiq_name']; ?></td>
<td><?php echo $maList['father_name']; ?></td>
<td><?php echo $maList['mustahiq_cnic']; ?></td>
<td><?php echo $maList['gender']; ?></td>
<td><?php echo $maList['contact_number']; ?></td>
<td><?php echo $maList['LZCActualName'];?></td>
<td><?php echo $maList['category'];?></td>
