...
<table width="100%" border="0" style="background:#E1E1E1;">
  <tr align="center">
    ...
    <td width="56%"><h4 class="card-title"><?php echo $MustahiqType?> Paid Mustahiqeen List of District <br /> <strong><?php echo $districtName;?></strong>
	During F/Y :  <strong><?php echo $financialYear;?></strong>
    </h4></td>
...
<?php
$i=1;
if(!empty($getCustomizePaidList))
{
foreach($getCustomizePaidList as $customizePaidList)
{
?>
<tr>
<td><?php echo $i;?></td>
<td><?php echo $customizePaidList['District_Name']; ?></td>
<td><?php echo $customizePaidList['mustahiq_name']; ?></td>
<td><?php echo $customizePaidList['father_name']; ?></td>
<td><?php echo $customizePaidList['mustahiq_cnic']; ?></td>
<td><?php echo $customizePaidList['gender']; ?></td>
<td><?php echo $customizePaidList['contact_number']; ?></td>
<td><?php echo $customizePaidList['LZCActualName'];?></td>
<td><?php echo $customizePaidList['category'];?></td>
<td><?php echo $customizePaidList['Remarks'];?></td>
