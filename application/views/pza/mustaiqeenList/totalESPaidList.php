...
<table width="100%" border="0" style="background:#E1E1E1;">
  <tr align="center">
    ...
    <td width="56%"><h4 class="card-title">Educational Stipend Paid Mustahiqeen List  <br />
...
<?php
$i=1;
if(!empty($esTotalList))
{
foreach($esTotalList as $esList)
{
?>
<tr>
<td><?php echo $i;?></td>
<td><?php echo $esList['District_Name']; ?></td>
<td><?php echo $esList['mustahiq_name']; ?></td>
<td><?php echo $esList['father_name']; ?></td>
<td><?php echo $esList['mustahiq_cnic']; ?></td>
<td><?php echo $esList['gender']; ?></td>
<td><?php echo $esList['contact_number']; ?></td>
<td><?php echo $esList['LZCActualName'];?></td>
<td><?php echo $esList['InstituteName'];?></td>
<td><?php echo $esList['category'];?></td>
...
XLSX.writeFile(wb, fn || ('Educational Stipend Mustahiqeen list.' + (type || 'xlsx')));
}
