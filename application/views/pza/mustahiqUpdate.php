...
{
	$get_mustahiq_query = $this->db->select('*')->from('mustahiqeen')->where('id',$get_mustahiq_id)->get();
	$getmustahiq_name = $get_mustahiq_query->row('mustahiq_name');
	
	$get_mustahiqid = $get_mustahiq_query->row('id');
	
	$getMustahiqDetails = $this->db->select('*')->from('mustahiqeen_details')->where('user_id',$get_mustahiqid)->get();
	$district_name = $getMustahiqDetails->row('disable_type');	
}
...
<form id="pzf_fund" action="<?php echo base_url(); ?>ApplicantManagement/mustahiqUpdateManage/" method="post" data-parsley-validate="" class="" enctype="multipart/form-data">
...
<input type="text" class="form-control" value="<?php echo $get_mustahiq_query->row('mustahiq_name');?>" name="mustahiq_name" readonly>
</div>
...
<div class="col-md-4 col-xs-12"> 
<input type="text" class="form-control" value="<?php echo $get_mustahiq_query->row('father_name');?>" name="father_name" readonly>
</div>
...
<input type="text" class="form-control" name="postal_address" value="<?php echo $get_mustahiq_query->row('postal_address');?>" readonly>
...
<input type="text" class="form-control" name="permanent_address" value="<?php echo $get_mustahiq_query->row('permanent_address');?>" readonly>
...
<?php //echo $get_mustahiq_query->row('mustahiq_cnic');?>


<input type="text" class="form-control" value="<?php echo $get_mustahiq_query->row('mustahiq_cnic');?>" name="mustahiq_cnic">
...
<!--
<?php echo $get_mustahiq_query->row('contact_number');?>
-->

<input type="text" class="form-control" value="<?php echo $get_mustahiq_query->row('contact_number');?>" name="contact_number" readonly>
...
<?php
echo $get_mustahiq_query->row('gender');
?>
...
<div class="col-md-4 col-xs-12"> 
<?php echo $get_mustahiq_query->row('LZCActualName')?>
<?php 
/*$get_lzcqery_id = $get_mustahiq_query->row('LZC_name');
$get_lzcqery_name = $this->db->select('*')->from('lzc_list')->where('id',$get_lzcqery_id)->get();
$lzc_name = $get_lzcqery_name->row('lzc_name');*/
?> 

<!--<select class="form-control col-md-6 col-xs-12" id="lzc" name="LZC_name" required="">
<option style="background:#0F0;" value="<?php //echo $get_lzcqery_id;?>" readonly> <?php //echo $lzc_name;?>  </option>-->
...
<input type="date" name="dob" onChange="findage(this.value);" id="dob" value="<?php echo date("Y-m-d",strtotime($get_mustahiq_query->row('dob')));?>" class="form-control col-md-6 col-xs-12" readonly>
...
<input type="text" class="form-control" id="age" name="age" value="<?php echo $get_mustahiq_query->row('age');?>" readonly>
...
<div class="col-md-4 col-xs-12"> 
<?php echo $marital_status = $get_mustahiq_query->row('marital_status');?> 
...
<input type="text" class="form-control" name="istehqaqnumber" value="<?php echo $get_mustahiq_query->row('istehqaqnumber');?>" readonly>
...
<textarea cols="10" rows="5" class="form-control col-md-10 col-xs-12" id="comments" name="comments"><?php echo $get_mustahiq_query->row('comments');?></textarea>
</div>
...
<div class="col-md-10 col-xs-12"><?php echo $getMustahiqDetails->row('disable_type');?></div>
</div>
</div>
<?php
}
...
<div class="col-md-10 col-xs-12"><?php echo $getMustahiqDetails->row('financial_assistance_type');?></div>
</div>
</div>
<?php
}
...
<?php 
$gold_status_value = $getMustahiqDetails->row('gold_status_value');
...
<?php 
echo $house_status_type = $getMustahiqDetails->row('house_status_type');
?>
</div>
</div>
<?php
...
<div class="col-md-2 col-xs-12"><?php echo $getMustahiqDetails->row('dependences_sons');?></div>
...
<?php echo $dependences_daughters = $getMustahiqDetails->row('dependences_daughters');?>
...
<div class="col-md-2 col-xs-12">
<?php echo $getMustahiqDetails->row('dependences_others');?>
</div>
...
<?php 
echo $monthly_income_value = $getMustahiqDetails->row('monthly_income_value');
?>
</div>
</div>
<?php
...
<div class="col-md-4 col-xs-12">
<?php echo $getMustahiqDetails->row('other_source_income_value1');?>
</div>
...
<div class="col-md-4 col-xs-12">
<?php 
echo $other_source_income_value2 = $getMustahiqDetails->row('other_source_income_value2');
?>
</div>
...
<div class="col-md-4 col-xs-12">
<?php 
$other_source_income_value2 = $getMustahiqDetails->row('other_source_income_value2');
...
<div class="col-md-4 col-xs-12">
<?php echo $getMustahiqDetails->row('bank_account_number');?>
</div>
...
<div class="col-md-4 col-xs-12">
<?php 
echo $bankaccount_value_marks = $getMustahiqDetails->row('account_balance');
?>
</div>
</div>
</div>
...
<div class="col-md-10 col-xs-12">
<?php 
echo $live_stock_type = $getMustahiqDetails->row('live_stock_type');
?>
...
?>
<div id="pesodiv">
Monthly Average Bill : <?php echo $getMustahiqDetails->row('pesco_bill');?>
</div>
<?php
}
else
