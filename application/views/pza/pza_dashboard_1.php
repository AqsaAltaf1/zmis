...
<div class="info-box-content text_align">
<span class="info-box-number">Yearly <?php echo $getfinancial_year;?> Allocation</span>
...
<?php
$total_pza_amount_query = $this->db->select_sum('pza_amount')->from('pza_fund')->where('status',1)->get();
//$this->db->last_query();
$total_pza_amount = $total_pza_amount_query->row('pza_amount');

$net_balance =  $total_pzfreceived_amount - $total_pza_amount;
...
<div class="info-box-content text_align">
<span class="info-box-number">PZA Allocation installment <?php echo $getfinancial_installment; ?></span>
<span class="info-box-number" style="color: green;"> 
...
<div class="info-box-content text_align">
<span class="info-box-number" >PZA Balance</span>
<span class="info-box-number" style="color: green;">


<?php
 $pzaBalance = $total_pzareceived_amount - $total_hoa_amount;
