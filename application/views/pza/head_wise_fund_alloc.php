...
<div class="row mb-2">
<div class="col-sm-8">
<h3 class="m-0 text-dark">Provincial Zakat Administration Head Wise Fund Disbursement</h3>
</div><!-- /.col -->
...
<span class="info-box-number">Fund Allocated To PZA for Year <strong style="color:red;"><?php echo $getfinancial_year;?></strong> Inst: <strong style="color:red;"><?php echo $getfinancial_installment;?></strong> </span>
...
<div class="info-box-content text_align">
<span class="info-box-number">Fund Disbursed During Year <strong style="color:red;"><?php echo $getfinancial_year;?></strong> Inst: <strong style="color:red;"><?php echo $getfinancial_installment;?></strong></span>
