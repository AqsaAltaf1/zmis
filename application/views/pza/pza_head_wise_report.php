            ...
            <div class="card card-primary card-tabs">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="ma-tab" data-toggle="pill" href="#ma" role="tab" aria-controls="ma" aria-selected="false">Not Paid Mustahiqeen</a>
                  </li>
...
<form class="form-horizontal form-label-left" method="post" action="<?php echo base_url()?>Pza_head_wise_report/headWiseReport" enctype="multipart/form-data" target="_blank">      
...
<option value="">All Districs Data</option>
<?php
$i = 1;
...
<span class="info-box-text">Total GA Mustahiq in ___</span>
...
<h3>Search Mustahiq Details who are Not Benefited with Zakat Fund</h3>
<br>
<div class=" row item form-group">
...
<div class="col-md-3 col-sm-3 col-xs-12">
<select class="form-control" id="installment">
<option>--Marriage Assistance Availed--</option>
...
<span class="info-box-icon"><i class="far fa-bookmark"></i></span>
<div class="info-box-content">
<span class="info-box-text">Total MA Mustahiq in ___</span>
<span class="info-box-number">41,410</span>
</div>
</div>
<div class="col-md-6"></div>
