...
<form class="form-horizontal form-label-left" method="post" action="<?php echo base_url(); ?>Pza_new_post/manage_add_post" enctype="multipart/form-data" novalidate>      
...
<input type="text" name="post_name" class="form-control col-md-8">
</div>
</div>


<div class=" row item form-group">
<label class="control-label col-md-3 col-sm-3 col-xs-12" for="post_name">Number of Post<span class="required">*</span>
</label>
<div class="col-md-8 col-sm-6 col-xs-12">
<input type="text" name="number_of_posts" class="form-control col-md-8">
</div>
</div>
...
<div class="col-md-8 col-sm-6 col-xs-12">
<select class="form-control col-md-8 col-sm-3 col-xs-12" name="bps_grade" id="bps">
...
<div class=" row item form-group">
<label class="control-label col-md-3 col-sm-3 col-xs-12" for="post_status">Post Category <span class="required">*</span>
</label>
<div class="col-md-8 col-sm-6 col-xs-12">
<select class="form-control col-md-8 col-sm-3 col-xs-12" name="post_category" id="post_status">
<option value="">---Select One---</option>
<option value="Regular (Provincial Level)">Regular (Provincial Level)</option>
<option value="Regular (Distict Level)">Regular (Distict Level)</option>
<option value="Zakat Paid Staff (Provincial Level)">Zakat Paid Staff (Provincial Level)</option>
<option value="Zakat Paid Staff (Distict Level)">Zakat Paid Staff (Distict Level)</option>
...
<div class=" row item form-group" id="district_div" style="display: none;" >
<label for="password" class="control-label col-md-3 col-sm-3 col-xs-12">Select District</label>
<div class="col-md-8 col-sm-6 col-xs-12">
<select class="form-control col-md-8 col-sm-3 col-xs-12" name="district_id" id="district_name">
...
<label for="" class="control-label col-md-3 col-sm-3 col-xs-12">Select Section</label>
<div class="col-md-8 col-sm-6 col-xs-12">
<select class="form-control col-md-8 col-sm-3 col-xs-12" name="section_name" id="section_name">
...
<div class="col-md-8 col-sm-6 col-xs-12">
<textarea class="form-control col-md-8 col-xs-12" name="job_description" cols="10" rows="5">
</textarea>
</div>
</div>
