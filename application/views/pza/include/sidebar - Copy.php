...
<?php 
if(($page == "Pza_fund_summary") || ($page == "Pza_reports") || ($page == "Pza_dist_reports") || ($page == "Pza_housestatus_reports") || ($page == "Pza_dist_genderwise_reports") || ($page == "Pza_category_wise_report") || ($page == "Pza_head_wise_report") || ($page == "Pza_hosp_reports")|| ($page == "Pza_RB_reports") || ($page == "Pza_hr_reports") || ($page == "Pza_distwise_disbursement_report") || ($page == "RejectedMustahiqeen") || ($page == "Pza_dist_profile") || ($page == "PzaDistwisePaidReport"))
{
?>
<li class="nav-item has-treeview menu-open">
<a href="#" class="nav-link active">
...
<li class="nav-item">
<a href="<?php echo base_url(); ?>Pza_dist_reports" class="nav-link <?php if($page == "Pza_dist_reports") echo "active";?>">
  <i class="far fa-circle nav-icon"></i>
