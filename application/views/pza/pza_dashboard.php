...
//District FUnd allocation by PZA
$totalDistrictAllocattion = $this->db->select_sum('total_fund')->from('district_payment')->where('financial_year',$getfinancial_year)->where('installment',$getfinancial_installment)->get();
$districtAllocattion = $totalDistrictAllocattion->row('total_fund');
$districtAllocattion_nf= number_format($districtAllocattion,2);

//Hospital FUnd allocation by PZA
$totalHospitalAllocattion = $this->db->select_sum('payment_amount')->from('hospital_payment')->where('financial_Year',$getfinancial_year)->where('installment',$getfinancial_installment)->get();
$hospitalAllocattion = $totalHospitalAllocattion->row('payment_amount');
$hospitalAllocattion_nf= number_format($hospitalAllocattion,2);
...
<div class="info-box-content text_align">
<span class="info-box-number">Total Expenditure from PZF A/C # 03</span>
<span class="info-box-number" style="color: green;"> 

<?php

$yearlyFundReserved = $this->db->select_sum('yearly_fund')->from('pza_yearly_fund_allocation')->where('status',1)->get();
//$this->db->last_query();
$total_reserved_amount = $yearlyFundReserved->row('yearly_fund');
echo number_format($total_reserved_amount,2);
...
<div class="info-box-content text_align">
<span class="info-box-number">PZF Balance as of Today <?php echo date("d/m/Y"); ?></span>
<span class="info-box-number" style="color: red;">
...
<div class="info-box-content text_align">
<span class="info-box-number" >PZA Fund for the Year <?php echo $getfinancial_year; ?></span>
<span class="info-box-number" style="color: green;">
...
<div class="info-box-content text_align">
<span class="info-box-number" >PZA Fund Balance </span>
<span class="info-box-number" style="color: red;">


<?php
$pzaFundBalance = $total_reserved_amount - $total_hoa_amount;
echo number_format($pzaFundBalance,2);
?>
...
<div class="col-sm-12 col-md-12">
<h3 class="text-dark" style="font-weight:bold;">Fund Allocation/Utilization Summary During  <?php echo $getfinancial_year; ?> by Districts and Hiospitals</h3>
</div>
...
<div class="info-box-content text_align">
<span class="info-box-number" >Districts Allocation During <?php echo $getfinancial_year; ?> </span>
<span class="info-box-number" style="color: green;">
<?php
echo $districtAllocattion_nf;
?>
...
<div class="info-box-content text_align">
<span class="info-box-number" >District Utilization During <?php echo $getfinancial_year; ?> </span>
<span class="info-box-number" style="color: green;">
...
<div class="info-box-content text_align">
<span class="info-box-number" >Balance After Utilization During <?php echo $getfinancial_year; ?> </span>
<span class="info-box-number" style="color: green;">
...
<div class="info-box-content text_align">
<span class="info-box-number" >Prov-Hospitals Allocation During <?php echo $getfinancial_year; ?> </span>
<span class="info-box-number" style="color: green;">
<?php
echo $hospitalAllocattion_nf;
?>
...
<div class="info-box-content text_align">
<span class="info-box-number" >Hospital Utilization During <?php echo $getfinancial_year; ?> </span>
<span class="info-box-number" style="color: green;">
...
<input type="text" class="form-control" required id="ga_percentage" name="ga_percentage" placeholder="GA Percentage">
</div>
</div>
...
<input type="text" class="form-control" required id="ma_percentage" name="ma_percentage" placeholder="MA Percentage">
</div>
</div>
<br>
...
<input type="text" class="form-control" required id="dm_percentage" name="dm_percentage" placeholder="DM Percentage">
...
<input type="text" class="form-control" required id="hc_percentage" name="hc_percentage" placeholder="HC Percentage">
...
<input type="text" class="form-control" required id="esa_percentage" name="esa_percentage" placeholder="ESA Percentage">
...
<input type="text" class="form-control" required id="esp_percentage" name="esp_percentage" placeholder="ESA Percentage">
</div>
</div>
