        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box">
              ...
              <div class="info-box-content text_align">
                <span class="info-box-number"> Fund Reserved For The Year <strong style="color: red;"><?php echo $getfinancial_year; ?></strong> </span>
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content text_align">
                <span class="info-box-number">Fund Released for Installment <strong style="color: red;"><?php echo $getfinancial_installment; ?></strong> </span>
                ...
                echo number_format($select_pza_allocation_query->row('pza_amount'),2); 
                ?>
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content text_align">
                ...
                <?php
            $yearly_reserve_balance = $total_yearly_reserved_amount - $total_pza_allocated_amount;
            $yearly_reserve_balance_nf= number_format($yearly_reserve_balance,2);
              echo $yearly_reserve_balance_nf;
              ?>
...
<input id="pzf_fund" class="form-control col-md-6 col-sm-6 col-xs-12" data-validate-length-range="" name="pzf_fund" type="text" placeholder="Fetch from PZF table" value="<?php echo number_format($gettotalnet_balance,2);?>" readonly>
...
<input type="number" id="yearly_fund" min="1" max="<?php echo $gettotalnet_balance;?>" name="yearly_fund" required data-validate-minmax="" class="form-control col-md-6 col-sm-6 col-xs-12">
</div>
