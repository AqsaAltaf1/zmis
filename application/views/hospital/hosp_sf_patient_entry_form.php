      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-9 col-md-9">
            <h3 class="m-0 text-dark" style="font-weight: bold;">Patient's Registration Form (Special Fund)</h3>
          </div><!-- /.col -->
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box">
              ...
              <div class="info-box-content text_align">
                <span class="info-box-number">Total Special Fund for <strong style="color: red;"><?php echo $hospital_name; ?></strong></span>
            ...
            <div class="card card-primary card-tabs">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill" href="#custom-tabs-one-home" role="tab" aria-controls="custom-tabs-one-home" aria-selected="true" style="font-weight: bold;">Patient's Registration Form (Special)</a>
                  </li>
                  <!-- <li class="nav-item">
...
<input required type="text" name="mustahiq_cnic" class="form-control col-md-7 col-xs-12" data-inputmask='"mask": "99999-9999999-9"' data-mask placeholder="Enter CNIC or Form-B to Fecth Patient's Personal Information">
<div class="col-md-1"></div>
...
<input type="date" name="discharge_date" id="discharge_date" value="" class="form-control col-md-4 col-xs-12" value="" placeholder="Patient's Discharge Date" >
 ...
 <h3 style="font-weight: bold; color: green;">Add Medication History</h3>
...
<h3 style="font-weight: bold; color: green;">Add Patient's Test</h3>


<table  class="table table-bordered table-striped small-text" id="tb_test">
<tr class="tr-header">
<th style="text-align: center;">Test Name</th>
<th style="text-align: center;">Unit Price</th>
<th style="text-align: center;">Quantity</th>
<th style="text-align: center;">Total Test Price</th>
<th style="text-align: center;">
<a href="javascript:void(0);" onclick="addsubtest();" style="font-size:12px; text-align: center;"  title="Add More Test" id="addmore_test"><span class="fas fa-plus"></span></a>
</th>
</tr>
...
<?php
$i = 1;
$select_test = "SELECT * FROM test_list order by test_name ASC";
$runselectqry_test = mysql_query($select_test);
while ($gettest = mysql_fetch_array($runselectqry_test))
{
?>
<option value="<?php echo $gettest['id']?>"><?php echo $gettest['test_name']; ?></option>
<?php 
$i++;
}
?>
...
<td>
<input type="number" class="form-control has-feedback-left"  id="test_unit_price1" name="test_unit_price[]" placeholder="Unit Price">
</td>
<td>
<input type="number" class="form-control has-feedback-left" onkeyup="calculate_total_test(1,this.value)" id="test_quantity1" name="test_quantity[]" placeholder="Quantity">
</td>
<td>
<input type="number" class="form-control totalsumtest" id="test_total_price1" name="test_total_price[]" placeholder="Total Test Price" readonly="">
</td>
<td style="text-align: center;">
<a href='javascript:void(0);'  style="font-size:14px;" class='remove'><span class='fa fa-trash'></span></a>
</td>
</tr>
<input id="totalsubtest" name="totalsubtest" value="1" type="hidden" />

 <tbody id="addmoretest"></tbody>

</table>


<h3 style="font-weight: bold; color: green;">Patient's Surgery Details</h3>

<table  class="table table-bordered table-striped small-text" id="tb_surgery">
<tr class="tr-header">
<th style="text-align: center;">Surgery Type</th>
<th style="text-align: center;">Surgeon Name</th>
<th style="text-align: center;">Surgery Result</th>
<th style="text-align: center;">Surgeon Fee</th>
<th style="text-align: center;">
<a href="javascript:void(0);" onclick="addsubsurg();" style="font-size:12px;" id="addMore_surgary" title="Add More Surgary"><span class="fas fa-plus"></span></a>
</th>
</tr>

<tr>
<td>
<input type="text" class="form-control has-feedback-left"  id="surgery_type" name="surgery_type[]" placeholder="Surgery type">
</td>

<td>
<input type="text" class="form-control has-feedback-left"  id="surgeon_name" name="surgeon_name[]" placeholder="Surgeon Name">
</td>
<td>
<input type="text" class="form-control has-feedback-left" id="surgery_result" name="surgery_result[]" placeholder="Surgery Result">
</td>
<td>
<input type="number" class="form-control totalsumsurg" id="surgeon_fee" name="surgeon_fee[]" onkeyup="calculate_total_surg(1,this.value)" placeholder="Surgen Total Fee">
</td>
<td style="text-align: center;">
<a href='javascript:void(0);'  style="font-size:14px;"class='remove'><span class='fa fa-trash'></span></a>
</td>
...
<input id="totalsubsurg" name="totalsubsurg" value="1" type="hidden" />

 <tbody id="addmoresurg"></tbody>
</table>
