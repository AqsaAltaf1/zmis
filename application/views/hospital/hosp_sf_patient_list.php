...
<h3 class="card-title">List of Special Fund Patients Served by  <strong><?php echo $hospital_name; ?></strong>  during  Financial Year:<strong><?php echo $getfinancial_year;?></strong> </h3>
...
<?php
$i=1;
if(!empty($get_all_sf_patients))
{
foreach($get_all_sf_patients as $get_sf_patient)
{
$district_id = $get_sf_patient['district'];
$lzc_id = $get_sf_patient['lzc'];
...
<tr>
<td><?php echo $i;?></td>
<td><?php echo $get_sf_patient['pt_name'];?></td>
<td><?php echo $get_sf_patient['fh_name']; ?></td>
<td><?php echo $get_sf_patient['pt_cnic']; ?></td>

<td><?php echo $district_name; ?></td>

<td><?php echo $lzc_name; ?></td>

<td><?php echo $get_sf_patient['gender']; ?></td>
<td>3</td>
<td><?php echo $get_sf_patient['cell_no']; ?></td>
<td><?php echo $get_sf_patient['disease']; ?></td>
<td><?php echo $get_sf_patient['total_expense']; ?></td>
<td><a type="button" class="glyphicon glyphicon-check btn btn-success" href="<?php echo base_url();?>Hosp_regular_patient_list/regular_patient_list_func/<?php echo $get_sf_patient['id'];?>"> <i class="fas fa-eye"></i> </a></td>
</tr>
<?php 
$i++;
}
