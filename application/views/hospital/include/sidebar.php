...
<li class="nav-item">
<a href="<?php echo base_url(); ?>Hosp_medicines_manage" class="nav-link <?php if($page == "Hosp_medicines_manage") echo "active";?>">
  <i class="far fa-circle nav-icon"></i>
  <p>Add Medicines</p>
</a>
</li>
...
<?php 
if(($page == "Hosp_monitoring_reporting"))
{
?>
<li class="nav-item has-treeview menu-open">
<a href="#" class="nav-link active">
...
<li class="nav-item">
<a href="<?php echo base_url(); ?>Hosp_monitoring_reporting" class="nav-link <?php if($page == "Hosp_monitoring_reporting") echo "active";?>">
  <i class="far fa-circle nav-icon"></i>
  <p>Patients Reports</p>
</a>
</li>
