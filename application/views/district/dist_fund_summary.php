      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8 col-md-10">
            <h4 class="m-0 text-dark">Fund Summary of District <strong><?php echo $district_name?></strong> </h4>
          </div><!-- /.col -->
          <div class="col-sm-4 col-md-2 div_align">
           
<h6 class="m-0 text-dark"> F/YEAR: <b> <?php echo $getfinancial_year;?></b> INST:<b style="color: black;"> 
<?php echo $get_inst;?>
</b> 
</h6>
          </div>
...
<?php
$net_balance =  $total_fund_received - $total_amount_sum;
...
<h3 class="card-title">District <strong><?php echo $district_name?></strong> fund disbursement Summary</h3>
</div>
<div class="row">
<div class="card col-12 col-md-12 col-sm-6">
<div class="card-header">
<h3 class="card-title">Summary Of District <strong><?php echo $district_name?></strong> regarding fund disbursement during   financial Year <strong><?php echo $getfinancial_year;?></strong> </h3>
<a target="_blank" href="" class="btn btn-primary float-right">Print Report</a>
</div>
<!-- /.card-header -->
<div class="card-body">
