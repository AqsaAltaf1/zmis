...
<option value="">---Select---</option>
<option value="Yes (House hold)">Yes (House Hold)</option>
<option value="No (Homeless)">No (Homeless)</option>
</select>
</div>
...
<option value="3 or Above Adult(Un-married)">3 or Above Adult (Un-married) Daughters</option>
<option value="2 Adult(Un-married)">2 Adult (Un-married) Daughters</option>
<option value="1 Adult(Un-married)">1 Adult (Un-married) Daughter</option>
</select>
...
<option value="">---Select---</option>
<option value="Employed (Non Govt. Employee)">Employed (Not Govt. Employed)</option>
