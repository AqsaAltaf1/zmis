...
/* count from Mustahiqeen table*/
$this->db->select("*");
$this->db->from("mustahiqeen");
$this->db->where("LZC_id",$get_lzcname['LZC_ID']);
$this->db->where("LZCActualName",$get_lzcname['LZC_Name']);
$countLzc = $this->db->get()->num_rows();

if ($get_lzcname['FormHandedOver']==$countLzc)
{
?>
...
<select class="form-control col-md-4 col-xs-12" onChange="checkMaritalStatus(this.value);"  id="marital_status" name="marital_status" required="">
