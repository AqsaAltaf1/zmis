...
<select class="form-control col-md-8" id="designationid" name="designation">
...
<input type="text" data-inputmask='"mask": "9999999999999"' data-mask name="cnic" required class="form-control col-md-8" min="13">
</div>


<div class="row form-group">
<label class="control-label col-md-3" for="cnic">Password<span class="required">*</span> </label>
<input type="password" id="password" name="password" required class="form-control col-md-8" value="" placeholder="password">
</div>



<div id="get_lzc_div" style="display:none;">
...
<input type="text" id="contact_no" data-inputmask='"mask": "9999-9999999"' data-mask name="contact_no" required class="form-control col-md-8" value="" placeholder="Contact No">
</div>
...
<input type="file" style="width:110%; height:45px;" class="form-control" name="emp_img" id="emp_img">
...
<input style="margin-right:3px;" type="submit" class="btn btn-success col-md-2" name="sbmitbtn" value="Submit">
...
<button type="button" class="glyphicon glyphicon-check btn btn-primary btn-sm" data-toggle="modal" data-target="#update<?php echo $i1;?>"> <i class="fas fa-edit"></i> </button>

<?php
if($designation_id == 1)
{
?>
<a class="glyphicon glyphicon-check btn btn-success btn-sm" href="<?php echo base_url();?>Dist_employees/dist_zakatpaid_user_lzcs/<?php echo $get_zakat_staff_values['id'];?>"> <i class="fas fa-list"></i> </a>
<?php
}
?>
...
<div class="modal fade" id="update<?php echo $i1;?>" tabindex="-1" role="dialog" aria-hidden="true">
<div class="modal-dialog modal-lg">
<div class="modal-content">
...
<select class="form-control col-md-8" id="" name="designation">
