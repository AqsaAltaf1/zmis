...
<?php
$i = 1;
$select_hospital = "SELECT * FROM hospital_users order by name ASC";
$runselectqry_hospital = mysql_query($select_hospital);
while ($gethospital = mysql_fetch_array($runselectqry_hospital))
{
?>
...
<div class="tab-pane fade show active" id="total-summary-tab" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
  <h4>Health Fund (Provincial Level) Receiving & Disbursement Financial Year <strong>2015-16</strong> Installment: <strong>1</strong> </h4>
  <div class="card-body">
