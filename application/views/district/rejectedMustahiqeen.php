...
$this->db->where('Remarks','');
$this->db->where('MustahiqType','Guzara Allowance');
$getNotAuditedMustahiqeen = $this->db->get()->num_rows();
...
<span class="info-box-number">Total Registered Mustahiqeen</span>
...
$x = ($getNotAuditedMustahiqeen * 100)/ $get_all_mustahiq;
echo round($x).' %';
...
<h3 class="card-title">Rejected Mustahiqeen List</h3>
...
<?php
$i=1;
if(!empty($getRejectedList))
{
foreach($getRejectedList as $rejectedList)
{
?>
<tr>
<td><?php echo $i;?></td>
<td><?php echo $rejectedList['LZCActualName']; ?></td>
<td><?php echo $rejectedList['mustahiq_name']; ?></td>
<td><?php echo $rejectedList['father_name']; ?></td>
<td><?php echo $rejectedList['mustahiq_cnic']; ?></td>
<td><?php echo $rejectedList['contact_number']; ?></td>
<td><?php echo $rejectedList['Audit_Observation']; ?></td>
<td><?php echo $rejectedList['rejectionReason']; ?></td>
</tr>
