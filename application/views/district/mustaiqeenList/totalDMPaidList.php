...
<table width="100%" border="0" style="background:#E1E1E1;">
  <tr align="center">
    ...
    <td width="56%"><h4 class="card-title">Deeni Madaris Paid Mustahiqeen List  <br />
...
<?php
$i=1;
if(!empty($dmTotalList))
{
foreach($dmTotalList as $dmList)
{
?>
<tr>
<td><?php echo $i;?></td>
<td><?php echo $dmList['District_Name']; ?></td>
<td><?php echo $dmList['mustahiq_name']; ?></td>
<td><?php echo $dmList['father_name']; ?></td>
<td><?php echo $dmList['mustahiq_cnic']; ?></td>
<td><?php echo $dmList['gender']; ?></td>
<td><?php echo $dmList['contact_number']; ?></td>
<td><?php echo $dmList['LZCActualName'];?></td>
<td><?php echo $dmList['InstituteName'];?></td>
<td><?php echo $dmList['category'];?></td>
...
XLSX.writeFile(wb, fn || ('MA Mustahiqeen list.' + (type || 'xlsx')));
}
