...
<table width="100%" border="0" style="background:#E1E1E1;">
  <tr align="center">
    ...
    <td width="56%"><h4 class="card-title">Guzara Allowance Paid Mustahiqeen List<br />
...
if(!empty($gaPaidList))
{
foreach($gaPaidList as $paidList)
{
?>
<tr>
<td><?php echo $i;?></td>
<td><?php echo $paidList['District_Name']; ?></td>
<td><?php echo $paidList['mustahiq_name']; ?></td>
<td><?php echo $paidList['father_name']; ?></td>
<td><?php echo $paidList['mustahiq_cnic']; ?></td>
<td><?php echo $paidList['gender']; ?></td>
<td><?php echo $paidList['contact_number']; ?></td>
<td><?php echo $paidList['LZCActualName'];?></td>
<td><?php echo $paidList['category'];?></td>
