...
<?php echo number_format($total_rzf_disbursement,2);?>
...
<?php
$net_balance =  $total_RZF_net - $total_rzf_disbursement;
...
<!-- Natural Calamity Fund info-boxes -->
<div class="col-12 col-sm-6 col-md-4">
<div class="info-box mb-3">
<span class="info-box-icon bg-primary elevation-1"><i class="fas fa-receipt"></i></span>
...
<span class="info-box-number" style="color: green;">
<?php
//echo number_format($total_rzf_disbursement,2);?>
<br>
 </span>
<small class="info-box-number">
<?php 
...
<span class="info-box-number" style="color: red;">
<?php
//$ncf_balance =  $get_ncf_dist_allocation - $total_rzf_disbursement;
