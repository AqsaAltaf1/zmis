...
<input type="text" class="form-control" value="<?php echo $get_mustahiq_query->row('mustahiq_name');?>" name="mustahiq_name">
</div>
...
<div class="col-md-4 col-xs-12"> 
<input type="text" class="form-control" value="<?php echo $get_mustahiq_query->row('father_name');?>" name="father_name">
</div>
...
<input type="text" class="form-control" name="postal_address" value="<?php echo $get_mustahiq_query->row('postal_address');?>">
...
<input type="text" class="form-control" name="permanent_address" value="<?php echo $get_mustahiq_query->row('permanent_address');?>">
...
<input type="text" class="form-control" value="<?php echo $get_mustahiq_query->row('contact_number');?>" name="contact_number">
...
<div class="col-md-4 col-xs-12">
<select class="form-control col-md-6 col-xs-12" id="gender" name="gender" required="">
<option style="background:#0F0;" value="<?php echo $get_mustahiq_query->row('gender')?>"> <?php echo $get_mustahiq_query->row('gender')?>  </option>
...
<option style="background:#0F0;" value="<?php echo $get_lzcqery_id;?>"> <?php echo $lzc_name;?>  </option>
...
<input type="date" name="dob" onChange="findage(this.value);" id="dob" value="<?php echo date("Y-m-d",strtotime($get_mustahiq_query->row('dob')));?>" class="form-control col-md-6 col-xs-12">
...
<input type="text" class="form-control" id="age" name="age" value="<?php echo $get_mustahiq_query->row('age');?>">
...
<input type="text" class="form-control" name="istehqaqnumber" value="<?php echo $get_mustahiq_query->row('istehqaqnumber');?>">
