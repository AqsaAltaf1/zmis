  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-10">
            <h3 class="m-0 text-dark">Category Wise Total Registered Mustahiqeen During <b> <?php echo $getfinancial_year;?> in District <?php echo $district_name;?></b></h3>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </div>
...
{
foreach($getDistrict as $districtList)
{
?>
<option value="<?php echo $districtList['district_name']; ?>"><?php echo $districtList['district_name']; ?></option>
<?php
$i++;
}
}
