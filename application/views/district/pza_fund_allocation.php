...
<div class="row">
  <div class="col-md-1"></div>
<div class="card card-primary col-md-10 col-sm-12 col-xs-12">
...
<input id="pzf_fund" class="form-control col-md-6 col-sm-6 col-xs-12" data-validate-length-range="" name="pzf_fund" type="text" placeholder="Fetch from PZF table" value="<?php echo $gettotalnet_balance;?>" readonly>
...
<input type="number" id="pza_fund" min="1" max="" name="pza_fund" required data-validate-minmax="" class="form-control col-md-6 col-sm-6 col-xs-12">
</div>
