...
<form class="form-horizontal form-label-left" method="post" action="<?php echo base_url(); ?>Dist_login/user_login_profile_update/" enctype="multipart/form-data" novalidate>      
