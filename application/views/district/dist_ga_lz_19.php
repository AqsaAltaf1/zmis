...
$this->db->where('MustahiqType','Guzara Allowance');
$this->db->where('Remarks','Reject');
$get_rejected_nobs = $this->db->get()->num_rows();


$CategoryQuery = $this->db->query("SELECT category, COUNT(*)as mustaghiqCategory FROM `mustahiqeen` WHERE `year` = '".$getfinancial_year."' AND `district_id` = '".$userid."' AND MustahiqType = 'Guzara Allowance' AND  Remarks != 'Reject'  GROUP BY category");
...
<span class="info-box-icon bg-primary elevation-1"><i class="fas fa-users"></i></span>
<div class="info-box-content text_align">
<span class="info-box-number">Approved Mustahiqeen <strong><?php echo $getfinancial_year;?></strong></span>
<span class="info-box-number" style="color: green;">
<?php
echo $mustahiqeenAfterRejection;
?>
 <br>
</span>
<small class="info-box-number">100%</small>
...
<span class="info-box-icon bg-primary elevation-1"><i class="fas fa-users"></i></span>
<div class="info-box-content text_align">
<span class="info-box-number">Rejected NOBs <strong><?php 
// echo $getfinancial_year;
?></strong></span>
<span class="info-box-number" style="color: red;">
<?php
echo $get_rejected_nobs;
?>
 <br>
</span>
<small class="info-box-number">100%</small>
...
<h5 class="text-dark">Category wise Approved Mustahiqeen (LZ-19)</h5>
</div>
<div class="row">
...
<a target="_blank" href="<?php echo base_url(); ?>Dist_GA_Lz_19/DistrictLz19Print" class="btn btn-primary btn-sm float-right">Print LZ-19 Mustahiqeen</a>
</div>
<!-- /.card-header -->
<div class="card-body">
<div class="row"></div>
...
{
foreach($get_all_mustahiqeen as $Lz19Mustahiqeen)
{
?>
<tr>
<td><?php echo $i;?></td>
<td><?php echo $Lz19Mustahiqeen['mustahiq_name']; ?></td>
<td><?php echo $Lz19Mustahiqeen['father_name']; ?></td>
<td><?php echo $Lz19Mustahiqeen['mustahiq_cnic']; ?></td>
<td><?php echo $Lz19Mustahiqeen['gender']; ?></td>
<td><?php echo $Lz19Mustahiqeen['contact_number']; ?></td>
<td>
<?php 
echo $Lz19Mustahiqeen['LZCActualName']; 
?>
</td>
<td><?php echo $Lz19Mustahiqeen['category'];?></td>
<td>

<a target="_blank" href="<?php echo base_url(); ?>Dist_GA_lz_19/gaMustahiqDetails/<?php echo $Lz19Mustahiqeen['id']; ?>" class="btn btn-success btn-sm">Details</a>
