...
<div class="card-header">
  <h3 class="card-title">LZC Wise Selected Orphan Mustahiqeen</h3>
</div>
              <!-- /.card-header -->
<div class="card-body">
...
<h4 class="modal-title" id="myModalLabel">Orphan Mustahiq Checque out Details </h4>
...
<div class="card">
<div class="card-header">
<h3 class="card-title">LZC WISE ALL - Guzara Allowance Mustahiqeen XXXXXXXXXXX </h3>
</div>
<!-- /.card-header -->
<div class="card-body">
