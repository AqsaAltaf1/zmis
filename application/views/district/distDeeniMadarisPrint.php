...
<table width="100%" border="0" style="background:#E1E1E1;">
  <tr align="center">
    ...
    <td width="56%"><h4 class="card-title">Deeni Madaris Mustahiqeen List of District <br />
...
<?php
$i=1;
if(!empty($getDeeniMadarisPrint))
{
foreach($getDeeniMadarisPrint as $DeeniMadarisPrint)
{
?>
<tr>
<td><?php echo $i;?></td>
<td><?php echo $DeeniMadarisPrint['InstituteName']; ?></td>
<td><?php echo $DeeniMadarisPrint['mustahiq_name']; ?></td>
<td><?php echo $DeeniMadarisPrint['father_name']; ?></td>
<td><?php echo $DeeniMadarisPrint['mustahiq_cnic']; ?></td>
<td><?php echo $DeeniMadarisPrint['gender']; ?></td>
<td><?php echo $DeeniMadarisPrint['contact_number']; ?></td>
<td>
<?php 
echo $DeeniMadarisPrint['LZCActualName']; 
?>
</td>
<td><?php echo $DeeniMadarisPrint['amount'];?></td>
<td><?php echo $DeeniMadarisPrint['add_date'];?></td>
...
XLSX.writeFile(wb, fn || ('Deeni Madaris Mustahiqeen list.' + (type || 'xlsx')));
}
