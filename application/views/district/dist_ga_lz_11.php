...
<span class="info-box-number">Approved Mustahiqeen <strong><?php;?></strong></span>
...
<span class="info-box-icon bg-primary elevation-1"><i class="fas fa-users"></i></span>
<div class="info-box-content text_align">
<span class="info-box-number">Remaining NOBs After Allocation <strong><?php 
// echo $getfinancial_year;
?></strong></span>
<span class="info-box-number" style="color: red;">
<?php
      $result = $mustahiqeenAfterRejection - $total_allocated_nobs;
if ($result <= 0)
  echo $get_remaining_nobs = 0;
else
  echo $get_remaining_nobs = $result;
...
$this->db->where('payment_amount',12000);
