...
<h3 class="m-0 text-dark">List of Orphan Paid Mustahiqeen in respect of District <strong><?php echo $district_name; ?></strong> </h3>
</div><!-- /.col -->
...
<div class="info-box-content text_align">
<span class="info-box-number">Remaining Mustahiqeen</span>
...
<h3 class="text-dark">Orphan Paid Mustahiqeen List</h3>
</div>
...
<li class="nav-item">
<a class="nav-link active" id="lz_19-tab" data-toggle="pill" href="#lz_19" role="tab" aria-controls="lz_19" aria-selected="true">Orphan Paid Mustahiqeen List</a>
</li>
<!-- <li class="nav-item">
...
<h3 class="card-title">Orphan Paid Mustahiqeen List of District <strong><?php echo $district_name; ?></strong> during Year: <strong><?php echo $getfinancial_year; ?></strong> </h3>
 <!-- Print list -->
...
$getbankquery = $this->db->select('*')->from('guzara_allowance_mustahiqeen_payments')->where('user_id',$mustahiq_id)->get();
echo $getbankname = $getbankquery->row('bank_name');
?>
...
<?php
$mustahiq_id = $getmustahiqinfo['id'];
$getaccount_number = $this->db->select('*')->from('guzara_allowance_mustahiqeen_payments')->where('user_id',$mustahiq_id)->get();
echo $getaccount_number_value = $getaccount_number->row('account_number');
?>
...
$mustahiq_id = $getmustahiqinfo['id'];
$getaccount_number = $this->db->select('*')->from('guzara_allowance_mustahiqeen_payments')->where('user_id',$mustahiq_id)->get();
echo $getaccount_number_value = $getaccount_number->row('cheque_number');
?>
...
$mustahiq_id = $getmustahiqinfo['id'];
$getaccount_number = $this->db->select('*')->from('guzara_allowance_mustahiqeen_payments')->where('user_id',$mustahiq_id)->get();
echo $getaccount_number_value = $getaccount_number->row('payment_amount');
?>
