  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h3 class="m-0 text-dark">Profile of Mr.__________ Designation:_____________ of Zakat & Ushr Department DZC <strong><?php echo $district_name; ?></strong> </h3>
          </div><!-- /.col -->
          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center">Muhammad Shahzad</h3>

                <p class="text-muted text-center">Computer Operator</p>

                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Posting Station</b> <a class="float-right">Peshawar (HQ)</a>
                  </li>
                  <li class="list-group-item">
                    <b>Service Length</b> <a class="float-right">10 Years</a>
                  </li>
                  <!-- <li class="list-group-item">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <p class="text-muted">Haripur, Khyber Pakhtunkhwa</p>
                ...
                <p class="text-muted">
                  <span class="tag tag-danger">Web Designing</span>
                  <span class="tag tag-success">Web Development</span>
                  <span class="tag tag-info">Javascript</span>
                  <span class="tag tag-warning">PHP</span>
                  <span class="tag tag-primary">Expert In MS-Office</span>
                </p>
