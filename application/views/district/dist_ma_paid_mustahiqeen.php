...
<h3 class="m-0 text-dark">List of Paid Mustahiqeen Regarding Marriage Assisatnce in respect of District <strong><?php echo $district_name;?></strong></h3>
</div><!-- /.col -->
...
<span class="info-box-number">Total Marriage Assistance Mustahqeen</span>
...
<h3 class="text-dark">Marriage Assisatnce Paid Mustahiqeen List</h3>
</div>
...
<li class="nav-item">
<a class="nav-link active" id="lz_19-tab" data-toggle="pill" href="#lz_19" role="tab" aria-controls="lz_19" aria-selected="true">Marriage Assisatnce Paid Mustahiqeen List</a>
</li>
...
<h3 class="card-title">Marriage Assisatnce Paid Mustahiqeen List of District <strong><?php echo $district_name;?></strong> during Year : <strong><?php echo $getfinancial_year;?></strong></h3>
<!-- Print list -->
<a target="_blank" href="<?php echo base_url(); ?>Dist_MA_paid_mustahiqeen/MarriageMustahiqeenPrint" class="btn btn-primary btn-sm float-right">Print Marriage Assistance Paid Mustahiqeen</a>
</div>
<!-- /.card-header -->
<div class="card-body">
<div class="row"></div>
...
<?php
$i=1;
if(!empty($dist_ma_paid_mustahiqeen))
{
foreach($dist_ma_paid_mustahiqeen as $paid_mustahiqeen)
{
?>
<tr>
<td><?php echo $i;?></td>
<td><?php echo $paid_mustahiqeen['LZCActualName'];?></td>
<td><?php echo $paid_mustahiqeen['mustahiq_name'];?></td>
<td><?php echo $paid_mustahiqeen['father_name'];?></td>
<td><?php echo $paid_mustahiqeen['mustahiq_cnic'];?></td>
<td><?php echo $paid_mustahiqeen['category'];?></td>
<td><?php echo $paid_mustahiqeen['bank_name'];?></td>
<td><?php echo $paid_mustahiqeen['account_number'];?></td>
<td><?php echo $paid_mustahiqeen['cheque_number'];?></td>
<td><?php echo $paid_mustahiqeen['payment_amount'];?></td>
</tr>
<?php 
$i++;
}
