...
<h3 class="m-0 text-dark">Approval Summary of Most Vulnerable Orphan of District <strong><?php echo $district_name; ?></strong> </h3>
</div><!-- /.col -->
...
<h3 class="text-dark">Orphan Mustahiqeen List (LZ-11)</h3>
</div>
...
<li class="nav-item">
<a class="nav-link active" id="lz_19-tab" data-toggle="pill" href="#lz_19" role="tab" aria-controls="lz_19" aria-selected="true">Orphan LZ-11 Mustahiqeen List</a>
</li>
<!-- <li class="nav-item">
...
<h3 class="card-title">Orphan (LZ-11) Mustahiqeen List of District <strong><?php echo $district_name; ?></strong>  during Year:<strong><?php echo $getfinancial_year; ?></strong> </h3>
 <!-- Print list -->
...
<?php
$getfinancialdata = $this->db->select('*')->from('dist_head_wise_fund')->where('lzc_institution_madrasa',$lzcid)->where('account_head','Guzara Allowance')->where('year',$getfinancial_year)->where('installment',$getfinancial_installment)->get();
...
{
?>
<a href="<?php echo base_url(); ?>Dist_orphan_Mustahiqeenlist/getmustahiqeenlist/<?php echo $lzcid; ?>" class="btn btn-success btn-sm"> View List</a></td>
<?php
}
?>
