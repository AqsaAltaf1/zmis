...
<table width="100%" border="0" style="background:#E1E1E1;">
  <tr align="center">
    ...
    <td width="56%"><h4 class="card-title">Marriage Assisatnce Paid Mustahiqeen List of District <br />
...
<?php
$i=1;
if(!empty($getMarriageMustahiqeenPrint))
{
foreach($getMarriageMustahiqeenPrint as $MarriageMustahiqeenPrint)
{
?>
<tr>
<td><?php echo $i;?></td>
<td>
<?php echo $MarriageMustahiqeenPrint['mustahiq_name']; ?></td>
<td><?php echo $MarriageMustahiqeenPrint['father_name'];?></td>
<td><?php echo $MarriageMustahiqeenPrint['mustahiq_cnic'];?></td>
<td> <?php echo $MarriageMustahiqeenPrint['LZCActualName'];?></td>
<td><?php echo $MarriageMustahiqeenPrint['category'];?></td>
<td><?php echo $MarriageMustahiqeenPrint['bank_name'];?></td>
<td><?php echo $MarriageMustahiqeenPrint['account_number'];?></td>
<td><?php echo $MarriageMustahiqeenPrint['cheque_number'];?></td>
<td><?php echo $MarriageMustahiqeenPrint['payment_amount'];?></td>
<td><?php echo $MarriageMustahiqeenPrint['add_date'];?></td>
...
XLSX.writeFile(wb, fn || ('List of Paid Marriage Assisatnce Mustahqeen of <?php echo $district_name;?>.' + (type || 'xlsx')));
}
