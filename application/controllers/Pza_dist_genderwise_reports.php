...
class Pza_dist_genderwise_reports extends CI_Controller {

	
	function __construct()
	{
	parent::__construct();
	$this->load->model('pza_dist_genderwise_reports_model');
	}


	public function index()
	{
		$data['get_all_districts'] = $this->pza_dist_genderwise_reports_model->get_all_districts();
		...
		$this->load->view('pza/pza_dist_genderwise_reports',$data);
	}
