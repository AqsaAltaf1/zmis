...
class PzaDistwisePaidReport extends CI_Controller {

	 
	function __construct()
	{
	parent::__construct();
	$this->load->model('PzaDistwisePaidReport_model');
	}


	public function index()
	{
		$data['get_all_districts'] = $this->PzaDistwisePaidReport_model->get_all_districts();
		$data['get_all_districts1'] = $this->PzaDistwisePaidReport_model->get_all_districts1();
		$this->load->view('pza/pzaDistwisePaidReport',$data);
	}
	...
	else if($report_type == "Edu-Stipend(P)")
	{
		...
		$this->db->where("installment",$inst_value);
		$this->db->order_by('id',"DESC");
		$data['esp_mustahiqeen_paid'] = $this->db->get()->result_array();
