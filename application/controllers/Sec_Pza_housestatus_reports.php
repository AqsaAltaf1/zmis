...
class Sec_Pza_housestatus_reports extends CI_Controller {

	
	function __construct()
	{
	parent::__construct();
	$this->load->model('Sec_Pza_housestatus_reports_model');
	}


	public function index()
	{
		$data['get_all_districts'] = $this->Sec_Pza_housestatus_reports_model->get_all_districts();
		$this->load->view('secretary/sec_pza_housestatus_reports',$data);
	}
