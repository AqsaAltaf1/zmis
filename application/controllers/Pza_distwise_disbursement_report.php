...
class Pza_distwise_disbursement_report extends CI_Controller {

	
	function __construct()
	{
	parent::__construct();
	$this->load->model('Pza_distwise_disbursement_report_model');
	}


	public function index()
	{
		$data['get_all_districts'] = $this->Pza_distwise_disbursement_report_model->get_all_districts();
		$data['get_all_districts1'] = $this->Pza_distwise_disbursement_report_model->get_all_districts1();
		$this->load->view('pza/pza_distwise_disbursement_report',$data);
	}
