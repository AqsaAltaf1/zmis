...
class Pza_dashboard extends CI_Controller {
...
$this->load->view('pza/pza_dashboard',$data);
}
...
if ($dist_hosp == 'allHeads')
{
$data['dashboardsearch'] = $this->pza_dashboard_model->totalReceivedSearch($dist_hosp,$acount_head,$start_date,$end_date);
} 
else if($dist_hosp != 'allHeads')
{
	
$data['dashboardsearch'] = $this->pza_dashboard_model->dashboardsearch($dist_hosp,$acount_head,$start_date,$end_date);
}
...
if ($acount_head == 'allHeads')
{
$data['dashboardsearch'] = $this->pza_dashboard_model->allHeadsSearch($dist_hosp,$acount_head,$start_date,$end_date);
} 
else if($acount_head != 'allHeads')
{
...
$start_date  = $this->input->post("start_date");
$end_date  = $this->input->post("end_date");
$data['dashboardsearch'] = $this->pza_dashboard_model->hospitalSearch($hospital_id,$start_date,$end_date);
$this->load->view('pza/pza_dashboardsearch',$data);	
}
