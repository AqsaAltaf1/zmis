...
class Dist_dashboard extends CI_Controller {
...
$this->load->model('dist_dashboard_model');
...
$data['get_all_lzclist'] = $this->dist_dashboard_model->get_all_lzclist($userid);
/*$data['get_all_headofaccounts'] = $this->dist_dashboard_model->get_all_headofaccounts();
$data['get_all_hospitals'] = $this->dist_dashboard_model->get_all_hospitals();
$data['get_pza_fundrecords'] = $this->dist_dashboard_model->get_pza_fundrecords();*/


$this->load->view('district/dist_dashboard',$data);
}
