...
function GA_Mustahiqeen_Save()				
{
		...
		$formArray['marks_2021']  = $gettoalmarks;
...
function VerifyCNIC()
{
		...
		$ChkCNIC = $this->db->select('*')
						->from('guzara_allowance_mustahiqeen')
		...
		$myResponse = new  ResponseResult();
			...
			$myResponse->Result = "Failed";
			$myResponse->Description = "Data Found for Applicant, Already Registered";
		}		
		else
		{
			$myResponse->Result = "Successful";
