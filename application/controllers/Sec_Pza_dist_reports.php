...
class Sec_Pza_dist_reports extends CI_Controller {
 
	
	function __construct()
	{
	parent::__construct();
	$this->load->model('Sec_Pza_dist_reports_model');
	}


	public function index()
	{
		$data['get_all_districts'] = $this->Sec_Pza_dist_reports_model->get_all_districts();
		$this->load->view('secretary/sec_pza_dist_reports',$data);
	}
	...
	public function yearlyHeadwiseSummary()
	{
		...
		$data ['get_all_districts'] = $this->Sec_Pza_dist_reports_model->get_all_districts();
		$data['getYearlyHeadwiseFund']=$this->Sec_Pza_dist_reports_model->getYearlyHeadwiseFund($getfinancial_year, $getInstallment);
		$this->load->view('secretary/sec_yearlyHeadwiseSummary', $data);
	}
