...
defined('BASEPATH') OR exit('No direct script access allowed');
	...
	class Pza_head_wise_report extends CI_Controller {

	function __construct()
	{
	parent::__construct();
	
	$this->load->model('PzaHeadWiseReportModel');
	...
	{
		$data['districtList'] = $this->PzaHeadWiseReportModel->districtList();
		$data['accountHead'] = $this->PzaHeadWiseReportModel->accountHead();
		$data['getInstallment'] = $this->PzaHeadWiseReportModel->getInstallment();
		$this->load->view('pza/pza_head_wise_report', $data);
	}
	...
	$this->load->view('pza/pza_head_wise_report');
	}
	...
	$data['gaTotalList']= $this->PzaHeadWiseReportModel->gaTotalList($getfinancial_year,$getInstallment);
	...
	$data['maTotalList']= $this->PzaHeadWiseReportModel->maTotalList($getfinancial_year,$getInstallment);
	...
	$data['dmTotalList']= $this->PzaHeadWiseReportModel->dmTotalList($getfinancial_year,$getInstallment);
	...
	$data['esTotalList']= $this->PzaHeadWiseReportModel->esTotalList($getfinancial_year,$getInstallment);
	...
	$data['gaPaidList']= $this->PzaHeadWiseReportModel->gaPaidList($getfinancial_year,$getInstallment);
