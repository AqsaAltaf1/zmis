...
class Pza_housestatus_reports extends CI_Controller {

	
	function __construct()
	{
	parent::__construct();
	$this->load->model('Pza_housestatus_reports_model');
	}


	public function index()
	{
		$data['get_all_districts'] = $this->Pza_housestatus_reports_model->get_all_districts();
		$this->load->view('pza/pza_housestatus_reports',$data);
	}
