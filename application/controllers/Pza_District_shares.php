...
class Pza_District_shares extends CI_Controller {
	...
	{
		$data['getSettledDistrictShares'] = $this->Pza_District_shares_model->getSettledDistrictShares();
		//$data['getMergedDistrictShares'] = $this->Pza_District_shares_model->getMergedDistrictShares();
		$this->load->view('pza/district_shares',$data);
	}
	...
	$this->Pza_District_shares_model->manage_district_payment($formArray);
		
		
	$this->session->set_flashdata('success','Record Added Successfully..!');	
		
	redirect(base_url('Pza_District_shares'));	
		
		
			
	}

	function pza_print_dist_zakatshares()
	{
	$formArray = array();
	$data['getSettledDistrictShares'] = $this->Pza_District_shares_model->getSettledDistrictShares();
	//$data['getMergedDistrictShares'] = $this->Pza_District_shares_model->getMergedDistrictShares();
	$data['get_district_payment_record'] = $this->Pza_District_shares_model->get_district_payment_record($formArray);
	$this->load->view('pza/pza_print_dist_zakatshares',$data);
}
