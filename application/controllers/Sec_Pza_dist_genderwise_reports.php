...
class Sec_Pza_dist_genderwise_reports extends CI_Controller {

	
	function __construct()
	{
	parent::__construct();
	$this->load->model('Sec_pza_dist_genderwise_reports_model');
	}


	public function index()
	{
		$data['get_all_districts'] = $this->Sec_pza_dist_genderwise_reports_model->get_all_districts();
		...
		$this->load->view('secretary/sec_pza_dist_genderwise_reports',$data);
	}
	
	function graphdata()
	{
		
	 	$yearWiseReportGraph = $this->input->post("yearWiseReportGraph");
		$data['yearWiseReportGraph'] = $this->input->post("yearWiseReportGraph");
		$this->load->view('secretary/sec_pza_dist_genderwise_reports',$data);
